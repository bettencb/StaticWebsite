...
<script src="{{ '/assets/js/terminal-registry.js' | relative_url }}"></script>
<script src="{{ '/assets/js/game-codebreaker.js' | relative_url }}"></script>
<script src="{{ '/assets/js/game-extraction.js' | relative_url }}"></script>
<script>
    /**
    ...
    document.addEventListener('keydown', function(e) {
        ...
        if (gameState === 'EXPLORING') {
            ...
            if (activeGame && activeGame.handleKey) activeGame.handleKey(e.code, e);
        }
    });
    ...
    function openTerminal(terminalObj) {
        ...
        activeGame = TerminalGames.pick();
        document.getElementById('terminal-overlay').style.display = 'flex';
        if (activeGame) activeGame.setup(terminalObj, completeTerminalHack);
    }
